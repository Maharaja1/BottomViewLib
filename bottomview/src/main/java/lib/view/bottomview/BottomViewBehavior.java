...
public class BottomViewBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public BottomViewBehavior(boolean behaviorTranslationEnabled, int navigationBarHeight) {
        super();
    ...
    public BottomViewBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BottomViewBehavior_Params);
        mTabLayoutId = a.getResourceId(R.styleable.BottomViewBehavior_Params_tabLayoutId, View.NO_ID);
        a.recycle();
    }
    ...
    public static <V extends View> BottomViewBehavior<V> from(V view) {
        ...
        if (!(behavior instanceof BottomViewBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomViewBehavior");
        }
        return (BottomViewBehavior<V>) behavior;
    }
